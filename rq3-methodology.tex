...
prediction on whether \code{try-catch} blocks are needed, {\xstate}
...
the \code{try-catch} blocks.  Second, we evaluate {\xtype} as
...
code snippets that need \code{try-catch} blocks with statements
