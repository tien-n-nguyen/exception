...
\title[Neural Exception Handling Recommender]{Neural Exception Handling Recommender}
...
needed to be handled. Our empirical evaluation shows that {\tool}
relatively improves by 12.3\% in F-score over the state-of-the-art
approach in \code{try-catch} block necessity checking. It also
achieves a high accuracy of 74\% in suggesting the statements to be
placed in a \code{try-catch} block. It can cover all the needed
...
shows that {\tool} improves by 5.8\% in F-score over the existing
