...
%because they are basic elements in source code.
%To distinguish between the vulnerable code and the surrounding code,
%for a vulnerable statement, we also consider the fixed statement
%during training. For the non-vulnerable statements or deleted ones, we
%use the zero vector.
%
