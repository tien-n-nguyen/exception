...
exception types for 3 instances (17\%) (\code{Hit-All}). The
...
types in a \code{try-catch} block. Among them, with \code{Hit-1}=33\%,
there are 27 instances in which at least one predicted exception type
is correct. With \code{Hit-2}=28\%, there are 23 instances in which
at least two of the predicted exception types are correct. With
\code{Hit-3} = 7\%, there are 6 instances that all three predicted
