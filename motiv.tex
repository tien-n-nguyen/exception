...
snippet in an answer to the StackOverflow question 15409223 on how to
...
Such a tool could recommend if a \code{try-catch} block is needed,
what lines need to be included in that block, and what exceptions need
to be handled.
