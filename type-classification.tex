...
at the beginning (with the \code{B-Try} label) and at the end of the
block (with the last respective \code{I-Try} label).
...
embedding for the entire \code{try-catch} block, and feed it into
