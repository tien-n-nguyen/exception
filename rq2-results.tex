...
and predicts correctly {\em all the statements in all \code{try-catch}
  blocks} (could have multiple blocks) for 62\% of the positive code
...
thus, better grouping them into a \code{try-catch} block.
