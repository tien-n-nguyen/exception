...
\begin{table}[t]
\caption{\code{Try}-Block Statement Detection Result ({\xstate} as Individual, Statement Level, GitHub Dataset) (RQ2)}
  \vspace{-12pt}
  \small
	\begin{center}
		\renewcommand{\arraystretch}{1}
...
the presence of \code{try-catch} blocks). From
...
%\vspace{-26pt}
\begin{table}[htpb]
  \caption{\code{Try}-Block Statement Detection Comparison ({\xblock}+{\xstate}, Statement Level, Small Dataset) (RQ2)}
  \vspace{-12pt}
  \small
	\begin{center}
		\renewcommand{\arraystretch}{1}
