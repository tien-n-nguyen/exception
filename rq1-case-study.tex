...
\code{InputStream} object. This example illustrates that {\em {\tool}
  is able to put the attention on the right (sub)tokens of those
  statements} including \code{InputStream}, \code{in}, \code{get},
\code{System}, \code{name}, \code{replace}, etc., leading to its
correct prediction of the presence of a \code{try-catch} block.
